    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Infrastructure insights and performance analytics
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  CPU, Memory, Disk, and Network usage over time
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Current resource usage distribution
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
        ...
        <TabsContent value="alerts" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Critical, warning, and info alerts over the past week
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="resources" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Servers with highest resource utilization
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="uptime" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                System availability over the past 6 months
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Pre-configured reports for different stakeholders
          </CardDescription>
        </CardHeader>
        <CardContent>
