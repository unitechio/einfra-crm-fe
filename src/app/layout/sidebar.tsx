      ...
      <div className="flex items-center justify-between p-4 border-b border-sidebar-border">
        {!isCollapsed && (
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-linear-to-br from-primary to-primary/80 rounded-lg flex items-center justify-center shadow-sm">
      ...
      {!isCollapsed && (
        <div className="p-4 border-t border-sidebar-border bg-sidebar/50">
          <div className="flex items-center space-x-3 p-2 rounded-lg bg-background/50 border border-border/50">
            <div className="w-8 h-8 bg-linear-to-br from-muted to-muted/80 rounded-full flex items-center justify-center">
